export default {
    ...
    common: {
        ...
        error: "오류",
        networkError: "네트워크가 불안정합니다. 다시 시도해주세요.",
    ...
    validation: {
        ...
        birthDateAdult: "만 18세 이상만 가입할 수 있어요",
    ...
    profile: {
        ...
        lastPhotoLockedTitle: "마지막 한 장은 삭제할 수 없어요",
    ...
    setupVoice: {
        ...
        // 클론 생성 후 즉시 폐기, 저희 서버에 저장하지 않음).
        recordingPrivacyNote: "• 음성 녹음은 저장되지 않으니 걱정하지 마세요.",
        exampleScriptTitle: "할말이 생각나지 않는다면 읽어주세요.",
        exampleScript:
