// Monochrome store brand marks (fill follows currentColor) shared by the
// DownloadCTA section and the small Navbar store buttons.

export function AppleLogo({ size = 24 }: { size?: number }) {
  return (
    <svg viewBox="0 0 384 512" width={size} height={size} fill="currentColor" aria-hidden className="shrink-0">
...
export function GooglePlayLogo({ size = 22 }: { size?: number }) {
  return (
    <svg viewBox="0 0 512 512" width={size} height={size} fill="currentColor" aria-hidden className="shrink-0">
